...
- **SwiftUI** — UI, navigation, sheets, onboarding
- **SpriteKit** — physics-based paper chit simulation inside the jar
- **SwiftUI Canvas / Shape API** — procedural crumpled ball and jar drawing
- **UIKit** — haptics, VoiceOver announcements
